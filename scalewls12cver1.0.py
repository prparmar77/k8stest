...
command = "ssh -t opc@%s -i %s '/home/opc/wlsk8s/scaleupdown.sh %s %s %s' " %(instance_ip,instance_identityfile,domainUID,namespace,managedServercount)
